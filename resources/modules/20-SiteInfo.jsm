...
extend(SiteInfo.prototype, {
    query: function SI_query(key, context, defaultValue) {
        ...
        if (typeof expr === "function")
            return expr.call(this, context, defaultValue);
        ...
        case "object":
            if (defaultValue && typeof defaultValue.length === "number")
        ...
        case XPathResult.FIRST_ORDERED_NODE_TYPE:
            return result.singleNodeValue || defaultValue || null;
        }
        return defaultValue;
    },

    queryAll: function SI_queryAll(key, context, defalutValue) {
        return this.query(key, context, defalutValue || []);
    },
